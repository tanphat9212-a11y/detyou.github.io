...
import { Link } from "react-router-dom"; // Import Link để kích hoạt click chuyển trang
import "./Category.css";
...
export default function CategorySection() { // Đổi tên hàm thành CategorySection cho đồng bộ trang chủ
  return (
        ...
        <div className="category-grid">
          {categories.map((item, index) => (
            <Link 
              to={item.path} 
              key={index} 
              style={{ textDecoration: "none", color: "inherit", display: "block" }} // Ép vùng click phủ kín ô vuông
